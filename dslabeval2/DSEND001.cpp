...
Now integers are present in S1 and S2 where as Q is empty. Reverse the contents of S2. Now, pop smaller out of the two top (S1.top and S2.top) integers and enqueue it in Q, assuming conflict will never appear. At the end, only Q will have n integers in non-decreasing order. 
Also, print the contents of Q, S1, and S2 after every successful insertion in Q.
Input Format
